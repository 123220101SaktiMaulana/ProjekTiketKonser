...
<body>
    ...
    <div class="logohome" style="margin-top: 20px; margin-bottom:100px;">
        <center> <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/64/MBTA.svg/2048px-MBTA.svg.png" alt="" style="height: 40px; margin-right: 5px;">
            <a style="color: black; font-family: Abril Fatface">TIKETIN</a>
        </center>
    ...
    <section class="container" style="margin-left: 100px;">
        <div style="display: flex; gap: 50px;">
            ...
            <div class="logincont">
                ...
                <h2 style="font-family: Poppins;margin-left: 170px;">Buat Akunmu</h2>
                ...
                <div class="login">
                    ...
                    $query = mysqli_query(
                        $konek,
                        "INSERT INTO login VALUES('','$name','$username','$password','user')"
                    ...
                    if ($query) { ?>
                        ...
                        Nama : <br>
                        <input type="text" style="border-radius: 8px; width : 400px; height: 40px; margin-bottom:10px;border-width:1px;" name="name"> <br>
                        Username : <br>
                        <input type="text" style="border-radius: 8px; width : 400px; height: 40px; margin-bottom:10px;border-width:1px;" name="username"> <br>
                        Password : <br>
                        <input type="password" style="border-radius: 8px; width : 400px; height: 40px;border-width:1px;" name="password" id="inputPassword"> <br>

                        <br>
                        <br>

                        <button class="btn btn-warning " type="submit " style="background-color: rgb(214, 130, 242);border-color: rgb(26, 26, 26); width : 400px; height: 40px;border-radius: 8px; margin-bottom:10px; border-style:none">REGISTER</button>
                        <center>
                ...
                <div style="margin-top:12px;margin-left:57px ;font-family:Poppins;font-size:13px;color:purple;">
                    <center><a>Proses register berhasil, silahkan kembali <a href='login.php'>Login?</a>
                        <?php
                    } else {
