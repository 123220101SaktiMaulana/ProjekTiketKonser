...
<head>
    ...
    <title>Input Tiket | Tiketin</title>
</head>
...
<body>
    ...
    $nama = $_POST['nama'];
    $email = $_POST['email'];
    $konser = $_POST['namakonser'];
    $jumlah = $_POST['jumlah'];
    $alamat = $_POST['alamat'];
    $id = $_POST['id'];
    $query = mysqli_query($konek, "SELECT * from tambahevent where judul='$konser'");
    while ($data = mysqli_fetch_array($query)) {
        $total = $data['harga'] * $jumlah;
    }
    $query = mysqli_query($konek, "INSERT INTO tiket VALUES('','$id','$nama','$email','$konser','$alamat','$jumlah','$total')") or die(mysqli_error($konek));
    ...
    if ($query) { ?>
        ...
        <div class="editnav">
            <nav class="navbar navbar-expand-lg navbar-dark ">
                ...
                <a class="navbar-brand" href="homesession.php" style="color:white ; font-family:Poppins;">TIKETIN</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav mr-auto">
                        <li class="nav-item" style="margin-left: 100px;">
                            ...
                            <form class="form-inline" action="searcheventuser.php" method="POST">
                    ...
                    <div class="navbar-nav ml-auto" style="font-family: Poppins;font-size:14px;">
                        <a href="lihattiket.php" style="margin-right: 13px;margin-top:8px;text-decoration:none; color:white;">Lihat Tiket </a>
        ...
        <section>
            ...
            <div class="editform container" style="display: flex;">
                ...
                <div class="formleft container" style="padding-left: 20px;padding-top:10px;margin-right:10px; padding-right:10px;">
                    ...
                    <h3>isi form buat pembelian tiket</h3><br><br>
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                <label style="margin-bottom: 20px;width:200px;" for="inputnamakonser">Pilih Konser </label>
                            </td>
                            <td> <select id="inputnamakonser" class="form-control " name="namakonser" style="margin-left: 10px;margin-bottom: 20px;width:500px; ">
                                    <?php
                                    include "konek.php";
                        ...
                        <tr>
                            <td><label style="margin-bottom: 20px;width:200px;" for="inputjumlah">Jumlah Tiket</label></td>
                        ...
                        <tr>
                            <td>
                                <label style="margin-bottom: 20px;width:200px;" for="inputalamat">Total Harga</label>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td><button type="submit" href="keranjangsession.php" role="button" style="padding:9px; font-size:16px;margin-left: 10px; background-color: blueviolet ; border-style:none; color: black; font-family: Poppins; color:white;border-radius:10px;">Beli Tiket</button></td>
                        </tr>
                    ...
                    <h5>
                        ...
                        Tiket akan segera diproses untuk pembayaran lebih lanjut sudah kami kirimkan ke email anda , ingin lihat tiket anda? klik
                    </h5>
                    <h5>

                        <a href='lihattiket.php'> disini </a>
                    </h5>
