...
<head>
    ...
    <title>Hapus Tiket | Tiketin</title>
</head>
...
<body>
    ...
    include "konek.php";
    $id = $_GET['id'];
    $query = mysqli_query($konek, "DELETE FROM tiket where idtiket=$id");
    if ($query) { ?>
        ...
        <section>
            ...
            <div class="editlihattiket container" style="Padding:180px;">
                ...
                <h1>Tiket anda sedang proses refund</h1>
                <p>Note : Kami belum bisa memastikan refund tiket anda, refund tiket konser dapat atau tidak tergantung kebijakan penyelenggara acara atau pembuat venue, yang menentukan prosedur dan syarat-syarat yang berlaku untuk pengembalian dana. Lebih lanjutnya akan kami hubungi ke Email anda yang sudah tertera, Terimakasih.</p>
                <br><br>
                <a href="lihattiket.php" style="text-decoration:none;padding:9px; font-size:16px;margin-left: 0px;margin-right:10px; background-color: red ; border-style:none; font-family: Poppins; color:white;border-radius:10px;">Kembali</a>
