    ...
    <section>
        ...
        <div class="editform container" style="display: flex;">
            ...
            <div class="formleft container" style="padding-left: 20px;padding-top:10px;margin-right:10px; padding-right:10px;">
                ...
                <form action="inputtiket.php" method="POST">
                ...
                ?>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><button type="submit" role="button" style="padding:9px; font-size:16px;margin-left: 10px; background-color: blueviolet ; border-style:none; color: black; font-family: Poppins; color:white;border-radius:10px;">Beli Tiket</button></td>
                        </tr>
