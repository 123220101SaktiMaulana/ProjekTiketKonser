...
<body>
    ...
    <section>
        ...
        $angka = 0;
        include 'konek.php';
        $query = mysqli_query($konek, "select * from contactus");
        while ($data = mysqli_fetch_array($query)) {
            ...
            <div class="editlihattiket container" style="display: flex;">
                ...
                <div class="formleft container" style="padding-left: 20px;padding-top:10px;margin-right:10px; padding-right:0px;padding-bottom:20px;">
                    ...
                    <h2>Pesan <span style="margin-left: 5px; color:blueviolet;"> <?php echo $angka; ?></span> </h2>

                    <table>
                        <tr>
                            <td>
                                <label style="margin-top:10px;width:100px;" for="inputnama">Nama</label>
                            </td>
                            <td>:</td>
                        ...
                        <tr>
                            <td>
                                <label style="margin-top:10px;width:100px;" for="inputnama">Email</label>
                            </td>
                            <td>:</td>
                        ...
                        <tr>
                            <td>
                                <label style="margin-top:10px;width:100px;" for="inputperihal">Perihal </label>
                            </td>
                            <td>:</td>
                            <td> <span style="margin-left: 10px;margin-bottom: 20px;"> <?php echo $data['perihal']; ?></span></td>
                        </tr>
                        <tr>
                            <td>
                                <label style=" margin-top:10px;width:100px;" for="inputjumlah">Pesan</label>
                            </td>
                            <td>:</td>
                            <td> <span style="margin-left: 10px;margin-bottom: 20px; width :100px;margin-right:20px;"><?php echo $data['pesan']; ?> </span></td>
                        </tr>


                    </table>
                    <br>
                    <a href=hapusinboxadmin.php?id=<?php echo $data['id']; ?> style="text-decoration:none;padding:9px; font-size:16px;margin-left: 0px; background-color: red ; border-style:none; font-family: Poppins; color:white;border-radius:10px;">Hapus Pesan</a>
