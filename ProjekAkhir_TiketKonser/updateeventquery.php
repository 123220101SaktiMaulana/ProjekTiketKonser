...
<body>
    ...
    if (isset($_POST['upload'])) {
        ...
        $target = 'C:/xampp/htdocs/ProjekAkhir_TiketKonser/' . basename($_FILES['gambar']['name']);
        move_uploaded_file($path, "$target");



        $query = mysqli_query($konek, "UPDATE tambahevent SET tanggal='$tanggal', judul='$judul',tempat='$tempat',harga='$harga',gambar='$gambar' where id='$id'") or die(mysqli_error($konek));
        if ($query) { ?>
            ...
            <section>
                ...
                <div class="editlihattiket container" style="Padding:180px;">
                    ...
                    <center>
                        ...
                        <h1>Event Berhasil Di Update XD</h1>
                        <br><br>
                        <a href="homesessionadmin.php" style="text-decoration:none;padding:9px; font-size:16px;margin-left: 0px;margin-right:10px; background-color: blueviolet ; border-style:none; font-family: Poppins; color:white;border-radius:10px;">Kembali ke Beranda</a>
                    </center>
