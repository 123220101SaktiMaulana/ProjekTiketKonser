...
<body>
    ...
    <div class="editnav">
        <nav class="navbar navbar-expand-lg navbar-dark ">
            <a class="navbar-brand" href="homesessionadmin.php"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/64/MBTA.svg/2048px-MBTA.svg.png" alt="" style="height: 40px; margin-right: 1px;"></a>
            <a class="navbar-brand" href="homesessionadmin.php" style="color:white ; font-family:Poppins;">TIKETIN</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav mr-auto">
                    <li class="nav-item" style="margin-left: 100px;">
                        ...
                        <form class="form-inline" action="searcheventadmin.php" method="POST">
                ...
                <div class="navbar-nav ml-auto" style="font-family: Poppins;font-size:14px;">
                    ...
                    <a href="tambahevent.php" style="margin-right: 13px;margin-top:7px;text-decoration:none; color:white;">Tambah Event </a>
    ...
    <section>
        ...
        <div class="container" style="display: flex; margin-top: 70px; gap: 64px;">

            <img src="https://ouch-cdn2.icons8.com/Wk21LIGk4L2B-oaY96KYH1faJJS69ASI0S8CPE6lcaQ/rs:fit:368:194/czM6Ly9pY29uczgu/b3VjaC1wcm9kLmFz/c2V0cy9zdmcvNTgy/LzIwMWZjYWU5LWYw/MzctNDBhMi1iZjc1/LTNlNmI3MWMxNGQ3/ZS5zdmc.png" style="height: 300px;" alt="..." width="500px">

            <div class="card1" style="background-image: url('https://media.istockphoto.com/id/1134068329/id/foto/violet-ungu-dan-biru-laut-defocused-blurred-gerak-gradien-latar-belakang-abstrak.jpg?s=612x612&w=0&k=20&c=xk2wpEUtdWZjMGQn8qHqxmjSoJeUB4BH368PMXy0cV8=');">

                <img src="https://ouch-cdn2.icons8.com/SaRCoiyFcXxOXal5eNBrS4-X37zMjXSRdzG57ALz8R4/rs:fit:368:466/czM6Ly9pY29uczgu/b3VjaC1wcm9kLmFz/c2V0cy9wbmcvNjgy/L2ExZGYxMGE0LTFk/NjMtNDA0Mi04ZWNj/LWI3OWU4N2ViM2Iw/Zi5wbmc.png" style="width: 200px; margin-right: 50px;" alt="">
                <h5 style="font-size: 30px; color:yellow; font-style:oblique;">
                    PESAN TIKET SEKARANG DAN TONTON KONSER FAVORITMU
                </h5>
    ...
    <section>
        ...
        <div class="editform container" style="display: flex;">
            ...
            <div class="formleft container" style="padding-left: 20px;padding-top:10px;margin-right:10px; padding-right:10px;">
                ...
                <h3>Selamat datang Admin, mau tambah event yaa XD</h3><br><br>

                <form method="POST" action="inputevent.php" enctype="multipart/form-data">

                    <table>
                        <tr>
                            <td>
                                <label style="margin-bottom: 20px;width:200px;" for="tanggal">Tanggal Event</label>
                            </td>
                            <td><input type="text" name="tanggal" class="form-control" style="margin-left: 10px;margin-bottom: 20px;width:500px;"></td>
                        </tr>
                        <tr>
                            <td>
                                <label style="margin-bottom: 20px;width:200px;" for="juduk">Judul Konser</label>
                            </td>
                            <td> <input type="text" name="judul" class="form-control" style="margin-left: 10px;margin-bottom: 20px;width:500px;"></td>
                        </tr>
                        <tr>
                            <td>
                                <label style="margin-bottom: 20px;width:200px;" for="tempat">Tempat </label>
                            </td>
                            <td> <input type="text" name="tempat" class="form-control " style="margin-left: 10px;margin-bottom: 20px;width:500px; ">
                            </td>
                        </tr>
                        <tr>
                            <td><label style="margin-bottom: 20px;width:200px;" for="inputjumlah">Harga</label></td>
                            <td><input type="text" name="harga" class="form-control" style="margin-left: 10px;margin-bottom: 20px;width:500px;" id="harga"></td>

                        </tr>
                        <tr>
                            <td>
                                <label style="margin-bottom: 20px;width:200px;" for="inputalamat">Foto Event</label>
                            </td>
                            <td> <input type="file" name="gambar" class="form-control" id="gambar" style="margin-left: 10px;margin-bottom: 20px;width:500px;"></td>
                        </tr>


                        <td></td>
                        <td><button type="submit" role="button" name="upload" style="padding:9px; font-size:16px;margin-left: 10px; background-color: blueviolet ; border-style:none; color: black; font-family: Poppins; color:white;border-radius:10px;">Tambah Event</button></td>
                        </tr>
