        ...
        <section>
            ...
            <div class="editlihattiket container" style="Padding:180px;">
                <center>
                    ...
                    <br><br>
                    <a href="homesessionadmin.php" style="text-decoration:none;padding:9px; font-size:16px;margin-left: 0px;margin-right:10px; background-color: red ; border-style:none; font-family: Poppins; color:white;border-radius:10px;">Cek Beranda</a>
                </center>
            </div>
