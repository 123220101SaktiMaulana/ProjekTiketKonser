...
<body>
    ...
    $query = mysqli_query(
        $konek,
        "INSERT INTO contactus VALUES('','$nama','$email','$perihal','$pesan')"
    ) or die(mysqli_error($konek));
    if ($query) { ?>
        <section>


            <div class="editlihattiket container" style="padding-left:180px;padding-right:180px;padding-top:70px;padding-bottom:70px;">
                <center>
                    <i class='bx bx-check-circle bx-tada' style='color:#4cff02; font-size:200px;'></i>
                    <br><br>
                    <h1>TERIMAKASIH MASUKANNYA ^_^</h1>
                    <br><br>
                    <a href="homesession.php" style="text-decoration:none;padding:9px; font-size:16px;margin-left: 0px;margin-right:10px; background-color: blueviolet ; border-style:none; font-family: Poppins; color:white;border-radius:10px;">Kembali ke Beranda</a>
                </center>
            <?php
        } else {
