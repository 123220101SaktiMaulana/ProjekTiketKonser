...
<body>
    ...
    include "konek.php";
    $id = $_GET['id'];
    $query = mysqli_query($konek, "DELETE FROM tambahevent where id=$id");
    if ($query) { ?>
        ...
        <section>
            ...
            <div class="editlihattiket container" style="Padding:180px;">
                <center>
                    ...
                    <h1>Event Telah DiHapus :(</h1>
                    <br><br>
                    <a href="homesessionsuperadmin.php" style="text-decoration:none;padding:9px; font-size:16px;margin-left: 0px;margin-right:10px; background-color: red ; border-style:none; font-family: Poppins; color:white;border-radius:10px;">Cek Beranda</a>
                </center>
            </div>
