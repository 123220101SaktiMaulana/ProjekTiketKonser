    ...
    if ($query) { ?>
        ...
        <section>
            ...
            <div class="editlihattiket container" style="Padding:180px;">
                ...
                <br><br>
                <a href="inboxadmin.php" style="text-decoration:none;padding:9px; font-size:16px;margin-left: 0px;margin-right:10px; background-color: red ; border-style:none; font-family: Poppins; color:white;border-radius:10px;">Kembali</a>
