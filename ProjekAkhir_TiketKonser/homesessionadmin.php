        ...
        <div class="media-scroller container">
            ...
            while ($data = mysqli_fetch_array($query)) { ?>
                ...
                <div class="media-element" style="text-decoration:none; color: rgba(62, 2, 62, 0.975);">
                    ...
                    <a href=hapusevent.php?id=<?php echo $data['id']; ?> style="text-decoration:none;text-align: center;padding:9px; font-size:16px;margin-left: 50px;margin-right: 50px;margin-bottom:15px; background-color: red ; border-style:none; font-family: Poppins; color:white;border-radius:10px;">Hapus Event</a>
