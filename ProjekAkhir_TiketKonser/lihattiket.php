...
<head>
    ...
    <title>Your Tiket | Tiketin</title>
</head>
...
<body>
    ...
    <section>
        ...
        include 'konek.php';
        $query = mysqli_query($konek, "select * from tiket where id = '$id'");
        while ($data = mysqli_fetch_array($query)) {
            $angka = $angka + 1; ?>
            ...
            <div class="editlihattiket container" style="display: flex;">
                ...
                <div class="formleft container" style="padding-left: 20px;padding-top:10px;margin-right:10px; padding-right:0px;padding-bottom:20px;">
                    ...
                    <h2>Tiket <span style="margin-left: 5px; color:blueviolet;"> <?php echo $angka; ?></span> </h2>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td> <span style="margin-left: 10px;margin-bottom: 20px;"> <?php echo $data['namakonser']; ?></span></td>
                        </tr>
                        <tr>
                            <td>
                                <label style="margin-top:10px;width:200px;" for="inputnama">Jumlah Tiket</label>
                            </td>
                            <td>:</td>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td> <span style="margin-left: 10px;margin-bottom: 20px;">Rp. <?php echo $data['total']; ?> </span></td>
                        </tr>
                    ...
                    <br>
                    <a href=hapustiket.php?id=<?php echo $data['idtiket']; ?> style="text-decoration:none;padding:9px; font-size:16px;margin-left: 0px; background-color: red ; border-style:none; font-family: Poppins; color:white;border-radius:10px;">Refund Tiket</a>
