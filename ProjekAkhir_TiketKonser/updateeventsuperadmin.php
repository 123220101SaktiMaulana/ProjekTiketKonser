...
<head>
    ...
    <title>Update Event | Tiketin</title>
</head>
...
<body>
    ...
    <div class="editnav">
        <nav class="navbar navbar-expand-lg navbar-dark ">
            <a class="navbar-brand" href="homesessionsuperadmin.php"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/64/MBTA.svg/2048px-MBTA.svg.png" alt="" style="height: 40px; margin-right: 1px;"></a>
            <a class="navbar-brand" href="homesessionsuperadmin.php" style="color:white ; font-family:Poppins;">TIKETIN</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav mr-auto">
                    ...
                    <form class="form-inline" action="searcheventsuperadmin.php" method="POST">
...
include 'konek.php';
$id=$_GET['id'];
$query=mysqli_query($konek,"SELECT * from tambahevent where id=$id");
...
?>
        ...
        <div class="editform container" style="display: flex;">
            ...
            <div class="formleft container" style="padding-left: 20px;padding-top:10px;margin-right:10px; padding-right:10px;">
                ...
                <h3>Selamat datang Admin, mau Update event yaa XD</h3><br><br>

                <form method="POST" action="updateeventquerysuperadmin.php" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?php echo $data['id']; ?>">
                    ...
                    <table>
                        <tr>
                            ...
                            <td><input type="text" name="tanggal" class="form-control" value="<?php echo $data['tanggal']; ?>" style="margin-left: 10px;margin-bottom: 20px;width:500px;"></td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td> <input type="text" name="tempat"  class="form-control " value="<?php echo $data['tempat']; ?>"  style="margin-left: 10px;margin-bottom: 20px;width:500px; ">
                                   </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td><button  type="submit" role="button" name="upload" style="padding:9px; font-size:16px;margin-left: 10px; background-color: blueviolet ; border-style:none; color: black; font-family: Poppins; color:white;border-radius:10px;">Update Event</button></td>
                        </tr>
