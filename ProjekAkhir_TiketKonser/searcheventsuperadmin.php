            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav mr-auto">
                    <li class="nav-item" style="margin-left: 100px;">
                        ...
                        <form class="form-inline" action="searcheventsuperadmin.php" method="get">
                            <input class="form-control mr-sm-0" type="search" placeholder="Cari Event Disini" aria-label="Search" style="border-top-right-radius: 0px ; border-bottom-right-radius: 0px; margin-right: 0px; width: 450px;">
    ...
    <div class="editmedia container">
        <div class="media-scroller container">
            ...
            if (isset($_POST['search'])) {
                $cari = $_POST['search'];
                $query = mysqli_query($konek, "select * from tambahevent where judul like '%" . $cari . "%'");
            } else {
            ...
            ?>
                ...
                <div class="media-element" style="text-decoration:none; color: rgba(62, 2, 62, 0.975);">
                    <img src="<?php echo $data['gambar']; ?>" alt="" style="background-color: yellow;">
