...
<head>
    ...
    <title>Hapus Event | Tiketin</title>
</head>
...
<body>
    ...
    include "konek.php";
    $id = $_GET['id'];
    $query = mysqli_query($konek, "DELETE FROM contactus where id=$id");
    if ($query) { ?>
        ...
        <section>
            ...
            <div class="editlihattiket container" style="Padding:180px;">
                ...
                <h1>Pesan Telah Dihapus</h1>
                <p>Note : Semoga Kedepan Perusahaan Kita Semakin Maju ^_^</p>
                <br><br>
                <a href="inboxsuperadmin.php" style="text-decoration:none;padding:9px; font-size:16px;margin-left: 0px;margin-right:10px; background-color: red ; border-style:none; font-family: Poppins; color:white;border-radius:10px;">Kembali</a>
