...
<body>
    ...
    <div class="editnav">
        <nav class="navbar navbar-expand-lg navbar-dark ">
            <a class="navbar-brand" href="home.php"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/64/MBTA.svg/2048px-MBTA.svg.png" alt="" style="height: 40px; margin-right: 1px;"></a>
            <a class="navbar-brand" href="home.php" style="color:white ; font-family:Poppins;">TIKETIN</a>
                ...
                <form action="" method="POST">
                    ...
                    <table>
                        <tr>
                            ...
                            <td> <input type="text" class="form-control" id="inputnama" style="margin-left: 10px;margin-bottom: 20px;width:500px;"></td>
                        </tr>
                        <tr>
                            <td>
                                <label style="margin-bottom: 20px;width:200px;" for="inputemail">Email</label>
                            </td>
                            <td> <input type="email" class="form-control" id="inputemail" style="margin-left: 10px;margin-bottom: 20px;width:500px;"></td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td><input type="number" max="10000" step="0" min="0" value="0" class="form-control" style="margin-left: 10px;margin-bottom: 20px;width:500px;" id="inputjumlah"></td>
                        ...
                        <tr>
                            <td>
                                <label style="margin-bottom: 20px;width:200px;" for="inputalamat">Total</label>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td><a class="btn" href="login.php" role="button" style=" font-size:16px;margin-left: 10px; background-color: blueviolet ; border-style:none; color: black; font-family: Poppins; color:white;border-radius:10px;">Beli Tiket</a></td>
                        </tr>
